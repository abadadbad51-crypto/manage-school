...
export const StatCard = ({ title, value, icon: Icon, color, trend }: StatCardProps) => (
  <motion.div
    ...
    className="h-full"
  >
    <Card className="relative h-full overflow-hidden group hover:shadow-2xl hover:shadow-slate-200/50 dark:hover:shadow-none transition-all duration-500 border-none bg-white dark:bg-slate-900 shadow-sm rounded-[1.5rem] p-6">
      {/* Decorative Gradient */}
